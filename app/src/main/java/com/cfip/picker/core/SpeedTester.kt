...
object SpeedTester {
     ...
     */
    fun test(ip: String, url: String, maxDurationMs: Long = 5000, expectedMbps: Int = 0): SpeedTestResult {
        return try {
     ...
     */
    fun testViaBaiduProxy(ip: String, url: String, maxDurationMs: Long = 5000, expectedMbps: Int = 0): SpeedTestResult {
